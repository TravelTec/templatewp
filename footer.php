...
<div class="footer-section site-footer" style="background: <?=(empty($footer_setting['footer_skin_color']) ? '#f4f4f4' : $footer_setting['footer_skin_color'])?>">

	<div class="container">	

		<div class="row footer-widget-section footer-sidebar">
...
<div class="footer-copyright-section" style="border-bottom: 5px solid <?=(empty($footer_setting['footer_skin_color']) ? '#f4f4f4' : $footer_setting['footer_skin_color'])?>;">
